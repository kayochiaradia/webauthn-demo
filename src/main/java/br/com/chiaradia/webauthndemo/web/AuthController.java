package br.com.chiaradia.webauthndemo.web;
...
import br.com.chiaradia.webauthndemo.utility.Utility;
...
public class AuthController {
    ...
    public String newUserRegistration(
        ...
        AppUserEntity existingUser = service.getUserRepo().findByUsername(username);
        if (existingUser == null) {
            UserIdentity userIdentity = UserIdentity.builder()
                    ...
                    .build();
            AppUserEntity saveUser = new AppUserEntity(userIdentity);
    ...
    public String newAuthRegistration(
            @RequestParam AppUserEntity user,
            HttpSession session
    ) {
        AppUserEntity existingUser = service.getUserRepo().findByHandle(user.getHandle());
        if (existingUser != null) {
    ...
    public ModelAndView finishRegisration(
        ...
        try {
            AppUserEntity user = service.getUserRepo().findByUsername(username);
            ...
            if (requestOptions != null) {
                ...
                AuthenticatorEntity savedAuth = new AuthenticatorEntity(result, pkc.getResponse(), user, credname);
